        ...
        <div className="ViolenceTips0">
            ...
            <div className="ViolenceTips">
                <div>
                    ...
                    <ul className="Tipos-Violência">
                        <li><strong></strong>- Divulgar/compartilhar fotos e vídeos intímos pela internet e/ ou redes
                            sociais,<br/> sem autorização da mulher, com o propósito de humilhá-la ou chantageá-la.
                        </li>
                        <li><strong></strong>- Utilizar redes sociais e celulares para propagar comentários
                            depreciativos em relação <br/> à mulher.
                        </li>
                    </ul>
                </div>
                <div>
            ...
            <Link className="linkto" to="/Definition">
                <button><h3>O QUE É VIOLÊNCIA DOMÉSTICA?</h3></button>
            </Link>
