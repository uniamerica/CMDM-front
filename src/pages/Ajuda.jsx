...
function Ajuda() {
    return (
        ...
        <div className="ajuda">
            ...
            <div className="cntaj">
                <p> De acordo com a Lei Maria da Penha, violência doméstica é qualquer ação ou omissão baseada no gênero
                    mulher, que lhe cause algum dano físico, moral ou patrimonial, sofrimento sexual ou morte.</p>
                <p>Para denunciar, você pode:</p>
                <p>Entrar em contato com o serviço de informações e denúncia da Central de Atendimento a
                    Mulher, <strong>ligando no 180.</strong></p>
                <p>Em casos de emergência, é necessário ligar para a polícia no número 190.</p>
                <p>Para contatar o que se pode dizer um “pronto socorro” dos direitos humanos, que atentem casos de
                    violação dos mesmos, <strong>disque 100.</strong></p>
                <p>O<strong>CRAS</strong> atende a população em situação de risco e vulnerabilidade social e promove o
                    acesso aos direitos e o fortalecimento dos vínculos familiares.</p>
